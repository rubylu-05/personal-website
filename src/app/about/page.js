export default function About() {
    return (
      <div className="mt-6 ml-6 mr-2">
        ...
        <h2 className="text-3xl font-heading text-secondary mb-4">Past, present, and future</h2>
        ...
        <h1 className="text-3xl font-heading text-secondary mb-4">Life outside of coding</h1>
        <p className="mb-4 font-body font-light">
          In the <span className="text-secondary">summer of 2024</span>, I worked on enhancing desktop applications and automating systems for YM Inc., a Toronto-based retail company that operates fashion brands across North America.
        </p>
        <p className="mb-4 font-body font-light">
          In <span className="text-secondary">winter 2025</span>, I interned at Hatch in their Niagara Falls office, where I dipped my toes into the complexities of hydropower optimization. I worked to improve the efficiency of hydroelectric dams and explored the use of machine learning for predicting water inflow - I found this experience to be a really interesting intersection of engineering, sustainability, and software.
        </p>
        <p className="mb-4 font-body font-light">
          In the <span className="text-secondary">fall of 2025</span>, I’ll be joining Amazon Web Services (AWS) in Seattle as an SDE intern, where I’ll be contributing to the DynamoDB team.
        </p>
        <p className="mb-12 font-body font-light">I’m currently on the lookout for <span className="text-secondary">summer 2026</span> internship opportunities.</p>
      </div>
    );
