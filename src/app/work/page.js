...
const projects = [
  {
    ...
    description: "Boxd Office is a Letterboxd analytics dashboard that I built and deployed as a personal project! It scrapes a Letterboxd user’s public profile and provides insight into their preferences and patterns. This project was motivated by my passion for movies and interest in data science; I wanted to obtain and transform raw viewing data into meaningful, interactive charts.",
  ...
  },
  {
    ...
    description: "Nudge was built at UofT Hacks, where our team of 4 wanted to tackle productivity and procrastination in a way that felt more human than typical productivity apps. We built a Chrome extension that observes your browser activity and responds with sarcastic commentary inspired by the game The Stanley Parable.",
