            ...
            <div className="grid grid-cols-5 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-2">
                {albums.map((album, index) => (
                    <div key={index} className="relative group">
                        ...
                        <div className={`absolute sm:flex flex-col -top-2 left-1/2 transform -translate-x-1/2 -translate-y-full bg-background p-2 sm:opacity-0 sm:group-hover:opacity-100 transition-all z-10 text-xs border border-primary whitespace-nowrap w-auto min-w-[120px] max-w-[300px] pointer-events-none
